 ...
 *
 * Eingabe ist eine JSON-Datei mit einer Liste von Zusammenführungen:
 *   [{ gewinner_slug, verlierer_slugs: [...], neuer_titel?, fusionstext? }, ...]
 *
 * Pro Eintrag: der Gewinner bekommt den Fusionstext (und ggf. einen korrigierten Titel),
 * die Verlierer werden gelöscht. Die Weiterleitungen der gelöschten Slugs gehören in
 * RATGEBER_ALIASE in stauden-server.js — dieses Skript gibt sie am Ende fertig aus, setzt
 * sie aber NICHT selbst, damit die Umleitungen im Code nachvollziehbar bleiben.
 *
